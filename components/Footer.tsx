          ...
          <FadeIn>
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-12 mb-16">
              ...
              <div className="flex flex-col items-start lg:items-end gap-1">
                ...
                <span className="text-3xl md:text-4xl font-light tracking-tight">CHF 35'000 <span className="text-base text-mint/40 font-normal">/ Jahr</span></span>
              </div>
            </div>
            ...
            <div className="border-t border-white/10 pt-12">
              <a
                ...
                className="group flex items-center justify-between w-full py-6 md:py-8 border-b border-white/10 hover:border-poppy transition-colors"
              >
                <span className="text-2xl md:text-5xl font-light group-hover:pl-4 transition-all duration-500 tracking-hc-partner">Kontakt aufnehmen</span>
